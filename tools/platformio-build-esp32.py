...
env.Append(
    ...
    CPPDEFINES=[
        ...
        "WITH_POSIX",
        "_GNU_SOURCE",
        ("IDF_VER", '\\"v4.4.3-175-ge70ccc0b60\\"'),
        "ESP_PLATFORM",
