...
env.Append(
    ...
    CPPDEFINES=[
        ...
        "WITH_POSIX",
        "_GNU_SOURCE",
        ("IDF_VER", '\\"v4.4.7-100-g006369f661-dirty\\"'),
        "ESP_PLATFORM",
